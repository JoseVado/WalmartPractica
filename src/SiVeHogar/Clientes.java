...
public class Clientes extends javax.swing.JPanel {
    ...
    private static final String buscarTexto = "Ingrese el nombre del cliente a buscar";
    ...
    private static final String[] datosTabla = new String [] {
        "Folio", "Nombre", "Apellidos", "Dirección","Teléfono"
    };
     ...
     */
    public Clientes(Dashboard parent) {
        initComponents();
        actualizarTabla();
    ...
    private void actualizarTabla(List<Map<String,Object>> datos){
        ...
        for(Map<String,Object> cliente: datos){
            ...
            for(String columna: datosBD){
                Object agregar = cliente.get(columna);
                if(agregar == null){
                    fila.add("");
                }else{
    ...
    private void nuevoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nuevoMousePressed
        // Abrir sección
        parent.actualizarPantalla(new UpClients(this));
    ...
    private void deleteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMousePressed
        ...
        if (idcell <= -1) {
            ...
            String id = datos.get(idcell).get("idCliente").toString();
    ...
    private void editMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editMousePressed
        ...
        if (idcell <= -1) {
            ...
            parent.actualizarPantalla(new UpClients(this,datos.get(idcell)));
        }
